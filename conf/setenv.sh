...
DOCKER_ADD_HOST="\
	...
	--add-host master1.hadoop:172.17.0.7\
	--add-host master2.hadoop:172.17.0.8\
	--add-host data1.hadoop:172.17.0.9\
	--add-host data2.hadoop:172.17.0.10\
	--add-host data3.hadoop:172.17.0.11\
	"
